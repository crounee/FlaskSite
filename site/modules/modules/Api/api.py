...
my_api.add_resource(StatisticUserMaxAchievements,'/StatisticUserMaxAchievements')
my_api.add_resource(StatisticUserSumPoints,'/StatisticUserSumPoints')
my_api.add_resource(StatisticUsersMaximumDifference,'/StatisticUsersMaximumDifference')
my_api.add_resource(StatisticUsersMinDifference,'/StatisticUsersMinDifference')
my_api.add_resource(StatisticUsersSevenDaysStreak,'/StatisticUsersSevenDaysStreak')
my_api.add_resource(UserData,'/UserData')
my_api.add_resource(AchievementsReceived,'/AchievementsReceived')
